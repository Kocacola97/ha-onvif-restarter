...
from .const import CONF_NOTIFY_ON_SUCCESS, DEFAULT_PORT, DOMAIN
...
class OnvifRestarterConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    def async_get_options_flow(config_entry):
        return OnvifRestarterOptionsFlow(config_entry)
    ...
    async def async_step_user(self, user_input=None):
        ...
        return self.async_show_form(
            ...
            data_schema=vol.Schema({
                ...
                vol.Optional(CONF_NOTIFY_ON_SUCCESS, default=False): cv.boolean,
            }),
            errors=errors,
        )


class OnvifRestarterOptionsFlow(config_entries.OptionsFlow):
    ...
    async def async_step_init(self, user_input=None):
        ...
        current = self._config_entry.options.get(
            ...
            self._config_entry.data.get(CONF_NOTIFY_ON_SUCCESS, False),
        )

        return self.async_show_form(
            step_id="init",
            data_schema=vol.Schema({
                vol.Optional(CONF_NOTIFY_ON_SUCCESS, default=current): cv.boolean,
            }),
        )
